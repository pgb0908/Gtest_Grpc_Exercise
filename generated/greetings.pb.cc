...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_greetings_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_greetings_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_greetings_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_greetings_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_greetings_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017greetings.proto\"\034\n\014HelloRequest\022\014\n\004nam"
  ...
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_greetings_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_greetings_2eproto = {
  false, false, 195, descriptor_table_protodef_greetings_2eproto, "greetings.proto", 
  &descriptor_table_greetings_2eproto_once, nullptr, 0, 2,
  schemas, file_default_instances, TableStruct_greetings_2eproto::offsets,
  file_level_metadata_greetings_2eproto, file_level_enum_descriptors_greetings_2eproto, file_level_service_descriptors_greetings_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK ::PROTOBUF_NAMESPACE_ID::Metadata
descriptor_table_greetings_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_greetings_2eproto);
  return descriptor_table_greetings_2eproto.file_level_metadata[index];
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_greetings_2eproto(&descriptor_table_greetings_2eproto);
